...
const experiences = [
  {
    title: "Associate Software Engineer(Contract Basis)",
    company_name: "OLAK Technologies",
    icon: "",
    iconBg: "#383E56",
    date: "MAR 2026 - Present",
    points: ["Worked on backend development using Spring Boot by designing relational database schemas, creating table structures, defining entity relationships with JPA (Hibernate), and developing RESTful CRUD APIs. Also contributed to the government-based EDCS project by fixing critical bugs, debugging production issues, and improving system stability and performance."],
  },
  {
